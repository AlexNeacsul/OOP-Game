...
public class Mage extends Character {
    ...
    public Mage(String name, int currentExperience, int level) {
        super(75, generateCharacterSpells(), 100, false, false, true, name,
    ...
    @Override
    public void Concede() {
        System.out.println("The mage is dead.");
    ...
    public void levelUp(Character character) {
        ...
        int strengthUp = randomNumber(1, 2);
        int dexterityUp = randomNumber(1, 3);
        int charismaUp = randomNumber(2, 4);
