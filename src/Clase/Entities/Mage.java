...
public class Mage extends Character {
    ...
    public Mage(int maxHealth, ArrayList<Spell> spells, int maxMana, boolean fireResist, boolean earthResist,
                boolean iceResist, String name, int currentExperience, int level,
                int strength, int dexterity, int charisma, int intelligence) {
        super(maxHealth, spells, maxMana, fireResist, earthResist, iceResist, name,
                currentExperience, level, 1, 3, 5);
        this.immunity = "Ice";
    }
